defmodule EducationPostgres do
  import Ecto.Query, warn: false

  alias Education.Repo
  alias Education.Schools.School
  ...
  """
  def list_schools(schools) do
    Repo.all(School, schools)
  end
  ...
  """
  def get_school!(clauses), do: Repo.get_by!(School, clauses)
