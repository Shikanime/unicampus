...
import (
	...
	education_search_api_v1alpha1 "gitlab.com/deva-hub/unicampus/projects/education_search/api/v1alpha1"
...
func (r *Repository) SearchSchool(school *education_search_api_v1alpha1.School) ([]*education_search_api_v1alpha1.School, error) {
	...
	res := make([]*education_search_api_v1alpha1.School, len(dbSchool.Hits.Hits))
...
func (r *Repository) SearchSchoolsByQuery(query string) ([]*education_search_api_v1alpha1.School, error) {
...
func (r *Repository) PutSchool(school *education_search_api_v1alpha1.School) error {
...
func (r *Repository) DeleteSchool(school *education_search_api_v1alpha1.School) error {
...
func formatSchoolDomain(in *School) *education_search_api_v1alpha1.School {
	return &education_search_api_v1alpha1.School{
		UUID: in.UUID,
	}
}
