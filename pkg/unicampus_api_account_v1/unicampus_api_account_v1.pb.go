...
// source: unicampus_api_account_v1.proto
...
func (*Credential) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{0}
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{1}
}
...
func (*SignInRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{2}
}
...
func (*SignInReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{3}
}
...
func (*SignUpRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{4}
}
...
func (*SignUpReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{5}
}
...
func (*SignOutRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{6}
}
...
func (*SignOutReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{7}
}
...
func (*CloseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{8}
}
...
func (*CloseReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7, []int{9}
}
...
var _AccountService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "unicampus_api_account_v1.proto",
}
...
func (m *Credential) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Email) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintUnicampusApiAccountV1(dAtA, i, uint64(len(m.Email)))
		i += copy(dAtA[i:], m.Email)
	}
	if len(m.Password) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintUnicampusApiAccountV1(dAtA, i, uint64(len(m.Password)))
...
func (m *Session) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Token) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintUnicampusApiAccountV1(dAtA, i, uint64(len(m.Token)))
...
func (m *SignInRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Credential != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintUnicampusApiAccountV1(dAtA, i, uint64(m.Credential.Size()))
...
func (m *SignInReply) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Session != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintUnicampusApiAccountV1(dAtA, i, uint64(m.Session.Size()))
...
func (m *SignOutRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Id) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintUnicampusApiAccountV1(dAtA, i, uint64(len(m.Id)))
		i += copy(dAtA[i:], m.Id)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
...
func encodeVarintUnicampusApiAccountV1(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *Credential) Size() (n int) {
	...
	l = len(m.Email)
	if l > 0 {
		n += 1 + l + sovUnicampusApiAccountV1(uint64(l))
	}
	l = len(m.Password)
	if l > 0 {
		n += 1 + l + sovUnicampusApiAccountV1(uint64(l))
...
func sovUnicampusApiAccountV1(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozUnicampusApiAccountV1(x uint64) (n int) {
	return sovUnicampusApiAccountV1(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Credential) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowUnicampusApiAccountV1
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthUnicampusApiAccountV1
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipUnicampusApiAccountV1(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipUnicampusApiAccountV1(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowUnicampusApiAccountV1
			}
			if iNdEx >= l {
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthUnicampusApiAccountV1
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipUnicampusApiAccountV1(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthUnicampusApiAccountV1 = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowUnicampusApiAccountV1   = fmt.Errorf("proto: integer overflow")
)

func init() {
	proto.RegisterFile("unicampus_api_account_v1.proto", fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7)
}

var fileDescriptor_unicampus_api_account_v1_0d0fd8f458dab7b7 = []byte{
	// 370 bytes of a gzipped FileDescriptorProto
	,
}
